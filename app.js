...
const sisterGroupsData = [
  { id: "1조", leader: "장세연", members: ["우수정", "정미진", "최찬미", "이은솜", "정래윤"] },
  { id: "2조", leader: "윤선욱", members: ["왕소정", "김혜수", "황두리", "이보경", "오혜수"] },
  { id: "3조", leader: "임정은", members: ["김성현", "현재륜", "박혜원", "강주영"] },
  { id: "4조", leader: "정재현", members: ["유진희", "이지은B", "한수련", "이현정", "이정현"] },
  { id: "5조", leader: "김현실", members: ["황예지", "김은혜B", "심은경", "임향희", "서윤진"] },
  { id: "6조", leader: "김민희B", members: ["임선우", "송은비", "김소연", "김메어리"] },
  { id: "7조", leader: "윤진욱", members: ["김민지", "유재은", "이다님", "김예린"] },
  { id: "8조", leader: "조봄이와", members: ["이정숙", "이유라", "안유진", "송하빈"] },
  { id: "9조", leader: "이지은A", members: ["조샘이나", "원지희", "구다솜", "김선영"] },
  { id: "10조", leader: "김유선", members: ["이효심", "양은정", "현지윤", "박은영A"] },
  { id: "11조", leader: "김태희", members: ["성경선", "조현정", "김상미"] },
  { id: "12조", leader: "이은혜", members: ["한경미", "김은혜A", "허영은", "샤오보"] },
  { id: "13조", leader: "이세라", members: ["김지나", "허설", "이은주", "신명주"] },
  { id: "14조", leader: "김화정", members: ["손수정", "김민경", "조현자", "이주영"] },
  { id: "15조", leader: "신선화", members: ["유혜영", "나하나", "명인애"] },
  { id: "16조", leader: "박금향", members: ["심후성", "이주연", "문경화", "한수지"] },
  { id: "17조", leader: "장혜연", members: ["정미선", "조은영", "김소희", "조순영"] },
  { id: "18조", leader: "이희승", members: ["박은영B", "김현주", "박금화", "부수정"] },
  { id: "19조", leader: "최정희", members: ["박소영", "유현진", "오진경", "조미선"] },
  { id: "20조", leader: "배유리", members: ["신영미", "안유선", "신민아", "김수민", "김다혜"] },
  { id: "21조", leader: "김민희A", members: ["김혜정", "강미정", "서재희", "김정원"] },
  { id: "22조", leader: "김주선", members: ["이근실", "지명덕", "조미애", "유성애", "이민강"] },
...
const sisterStaffData = {
  ...
  otherGroups: ["신영화", "김경원", "조은미", "차윤", "유키", "김미현", "윤영경"],
};
...
const brotherGroupsData = [
  ...
  { id: "6조", leader: "박영재", members: ["이순환", "조대운", "최윤석"] },
  { id: "7조", leader: "전영진", members: ["박준석", "박현재", "이상민", "이진희", "김태준"] },
  { id: "8조", leader: "김경천", members: ["이동엽", "박보민", "유제현", "박윤환"] },
  { id: "9조", leader: "조재화", members: ["정환혁", "조화평", "정상혁", "김영준"] },
  { id: "10조", leader: "이재길", members: ["오성택", "권대호", "김범준", "여인설"] },
  { id: "11조", leader: "김보근", members: ["변해균", "이찬우", "안동영", "이주호", "구완준"] },
  { id: "12조", leader: "김세원", members: ["정현석", "최정호", "박상현", "김윤수"] },
  { id: "13조", leader: "박성영", members: ["김호균", "이재오", "심규영", "김명식"] },
  { id: "14조", leader: "박진우", members: ["도준영", "김유진", "주찬영", "김수호"] },
  { id: "15조", leader: "이상혁", members: ["김용진", "박명철", "한상혁", "정현민"] },
  { id: "16조", leader: "이우근", members: ["윤정훈", "한현호", "박지훈", "김성현"] },
  { id: "17조", leader: "장두상", members: ["조원기", "박동현", "정재순", "이재호"] },
  { id: "18조", leader: "최준희", members: ["구성현", "김성일", "정성안", "이정욱"] },
  { id: "19조", leader: "신원수", members: ["전만기", "김찬희", "김우람", "김현명"] },
  { id: "20조", leader: "최종범", members: ["김동철", "이호준", "김상훈", "김응도"] },
  { id: "21조", leader: "김동만", members: ["권성대", "조진웅", "김하람", "안상준"] },
  { id: "22조", leader: "정영석", members: ["박은총", "김태수", "선우강", "장윤환"] },
  { id: "23조", leader: "김흥규", members: ["김상옥", "유성애", "김주선", "이근실", "이민강"] },
  { id: "온라인", leader: "서정영", members: ["이경하", "손영준"] },
...
const brotherStaffData = {
  ...
  otherGroups: ["강우석", "박태곤", "장현빈", "남정완", "최민택", "김태원", "정연수"],
};
...
window.calculateFamilyFee = function(family, allFamilies) {
  ...
  attendingMembers.forEach(m => {
    ...
    if (group === "유치부") {
      type = "preschool";
      preschoolNames.push(m[0]);
    } else if (group === "유아") {
      type = "toddler";
      toddlerNames.push(m[0]);
    ...
    if (type !== "toddler") {
      ...
      if (snackDays > 0) {
        snackMembers.push({ name: m[0], days: snackDays });
      }
    }
  });
...
function renderFamilies() {
  ...
  if (document.body.classList.contains("mobile-mode")) {
    ...
    document.querySelector("#familyCardList").innerHTML = visibleFamilies.map((family) => {
      ...
      const adultNames = feeResult.details.adultNames || [];
      const childNames = feeResult.details.childNames || [];
      const preschoolNames = feeResult.details.preschoolNames || [];
      const toddlerNames = feeResult.details.toddlerNames || [];
      const snackMembers = feeResult.details.snackMembers || [];

      const breakfastCount = adultBreakfast + childBreakfast + preschoolBreakfast + toddlerBreakfast;
      
      let snackFormula = "";
      if (snackMembers.length > 0) {
        const firstDays = snackMembers[0].days;
        const allSameDays = snackMembers.every(m => m.days === firstDays);
        const names = snackMembers.map(m => m.name).join(", ");
        if (allSameDays) {
          snackFormula = `${snackCost.toLocaleString()}원 = ${snackMembers.length}인 x ${firstDays}일 x 3,000원 (과금대상: ${names})`;
        } else {
          const terms = snackMembers.map(m => `${m.name} ${m.days}일`).join(" + ");
          snackFormula = `${snackCost.toLocaleString()}원 = (${terms}) x 3,000원 (과금대상: ${names})`;
        }
      } else {
        snackFormula = `0원 (과금대상: 없음)`;
      }
            ...
            <div class="detail-section">
              ...
              <div style="background: #f4f7f5; border: 1px solid #dfe7e3; border-radius: 12px; padding: 12px 14px; font-size: 11px; color: #40534c; line-height: 1.6;">
                <div style="font-weight: 700; color: #1e5a45; font-size: 11px; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 8px 12px; padding-bottom: 8px; border-bottom: 1px dashed #dfe7e3; margin-bottom: 8px;">
                  <div style="display: flex; gap: 8px 12px; align-items: center;">
                ...
                <div style="display: flex; flex-direction: column; gap: 4px;">
                  ...
                  <div style="padding-left: 8px; color: #5f746b; line-height: 1.5;">
                    • 성인/청소년: 아침 ${adultBreakfast}회 x 2,000원 + 중/석식 ${adultLunchDinner}회 x 10,000원 = ${(adultBreakfast * 2000 + adultLunchDinner * 10000).toLocaleString()}원 (대상: ${adultNames.join(", ") || "없음"})<br/>
                    • 어린이(초등/유년): 아침 ${childBreakfast}회 x 2,000원 + 중/석식 ${childLunchDinner}회 x 9,000원 = ${(childBreakfast * 2000 + childLunchDinner * 9000).toLocaleString()}원 (대상: ${childNames.join(", ") || "없음"})<br/>
                    • 유치부 아동: 아침 ${preschoolBreakfast}회 x 2,000원 + 중/석식 ${preschoolLunchDinner}회 x 7,000원 = ${(preschoolBreakfast * 2000 + preschoolLunchDinner * 7000).toLocaleString()}원 (대상: ${preschoolNames.join(", ") || "없음"})<br/>
                    • 유아부 아동: 아침 ${toddlerBreakfast}회, 중/석식 ${toddlerLunchDinner}회 = 0원 (무료) (대상: ${toddlerNames.join(", ") || "없음"})
                  </div>
...
function renderMeals() {
  ...
  document.querySelector("#mealSummaryNumbers").innerHTML = `
    <div class="meal-summary-number"><span>전체 식수</span><b>${totalServings.toLocaleString()}명분</b></div>
    <div class="meal-summary-number"><span>성인/청소년</span><b>${adultServings.toLocaleString()}명분</b></div>
    <div class="meal-summary-number"><span>어린이(초등/유년)</span><b>${childServings.toLocaleString()}명분</b></div>
    <div class="meal-summary-number"><span>유치부 아동</span><b>${preschoolServings.toLocaleString()}명분</b></div>`;
  renderMealBarChart();
...
function renderMealCard(meal) {
  ...
  const period = meal.id.split("-").at(-1);
  const adultPrice = period === "breakfast" ? 2000 : 10000;
  const childPrice = period === "breakfast" ? 2000 : 9000;
  const preschoolPrice = period === "breakfast" ? 2000 : 7000;
  ...
  return `
    <div class="meal-card">
      ...
      <div class="meal-groups">
        ...
        <button class="meal-group-button" data-meal-id="${meal.id}" data-meal-group="adult"><span>성인/청소년 (${adultPrice.toLocaleString()}원)</span><b>${adultCount}명</b></button>
        <button class="meal-group-button" data-meal-id="${meal.id}" data-meal-group="child"><span>어린이 (${childPrice.toLocaleString()}원)</span><b>${childCount}명</b></button>
        <button class="meal-group-button" data-meal-id="${meal.id}" data-meal-group="preschool"><span>유치부 (${preschoolPrice.toLocaleString()}원)</span><b>${preschoolCount}명</b></button>
      </div>
    </div>`;
}
...
function openMealDrawer(meal, group) {
  ...
  const labels = {
    all: "총 인원",
    adult: `성인/청소년 (${adultPrice.toLocaleString()}원)`,
    child: `어린이 (${childPrice.toLocaleString()}원)`,
    preschool: `유치부 (${preschoolPrice.toLocaleString()}원)`
  };
...
document.addEventListener("click", (event) => {
  ...
  const driveFolder = event.target.closest(".drive-folder-card");
